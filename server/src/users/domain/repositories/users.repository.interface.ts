...
import { RetrieveAllUserResponseDTO, RetrieveUserResponseDTO } from "src/users/application/dtos/response/read-response.dto";
...
export abstract class IUserRepository {
  ...
  abstract create(data: CreateUserDTO): Promise<CreateUserResponseDTO>;
  abstract update(id: string, data: UpdateUserDTO): Promise<UpdateUserResponseDTO>;
