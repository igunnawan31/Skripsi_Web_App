...
import RekapCutiShowSkeletonDetail from "./RekapKinerjaShowsSkeletonDetail";
import { useProject } from "@/app/lib/hooks/project/useProject";
import RekapGajiShowSkeletonDetail from "./RekapKinerjaShowsSkeletonDetail";

export default function RekapitulasiKinerjaShowsDetail({ id }: { id: string }) {
